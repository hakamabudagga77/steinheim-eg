  ...
  return (
    <PageTransition>
      <div className="bg-[#ece9e2] text-[#0a0a0a]">
        {/* Hero */}
        <section dir="ltr" className="relative flex min-h-[75svh] items-end overflow-hidden bg-black pt-20 text-white text-left">
          <AutoplayVideo
        ...
        <section dir="ltr" className="px-5 py-24 sm:px-8 lg:px-16 lg:py-32 text-left">
        ...
        {/* Browse CTA */}
        <section dir="ltr" className="px-5 pb-24 sm:px-8 lg:px-16 lg:pb-32 text-left">
          <div className="mx-auto max-w-[1780px]">

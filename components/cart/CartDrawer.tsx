...
export default function CartDrawer({ locale }: { locale: string }) {
  ...
  // below navigate via next-intl Link while calling setOpen(false) in the same
      ...
      >
            ...
            <header className="shrink-0 border-b border-charcoal/8 px-5 sm:px-7 py-6">
              <div className="flex items-center justify-between">
                <div>
                  <h2 id="cart-drawer-title" className="font-heading text-[26px] leading-tight">{t("title")}</h2>
